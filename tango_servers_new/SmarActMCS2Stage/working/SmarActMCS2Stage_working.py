...
class SmarActMCS2Stage(Device):
    ...
    **Properties:**
    ...
    - Device Property
        XMotorDevice
            - name of the motor device controling the axis x (intermag/mcs2motor/x)
            - Type:'str'
        YMotorDevice
            - name of the motor device controling the axis y (intermag/mcs2motor/y)
            - Type:'str'
        ZMotorDevice
            - name of the motor device controling the axis z (intermag/mcs2motor/z)
            - Type:'str'
    """
    ...
    XMotorDevice = device_property(
        dtype='str',
        doc="name of the motor device controling the axis x (intermag/mcs2motor/x)",
        mandatory=True
    )

    YMotorDevice = device_property(
        dtype='str',
        doc="name of the motor device controling the axis y (intermag/mcs2motor/y)",
        mandatory=True
    )

    ZMotorDevice = device_property(
        dtype='str',
        doc="name of the motor device controling the axis z (intermag/mcs2motor/z)",
        mandatory=True
    )
