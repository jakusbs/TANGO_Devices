...
#----- PROTECTED REGION ID(ZI.additionnal_import) ENABLED START -----#
import numpy as np
import zhinst
...
class ZI (PyTango.Device_4Impl):
    """Implementation of ZI MFLI into the setup"""
    ...
    def write_Amplitude(self, attr):
        ...
        #----- PROTECTED REGION ID(ZI.Amplitude_write) ENABLED START -----#
        self.daq.setDouble('/dev4855/sigouts/0/amplitudes/0', data)
        self.daq.setInt('/dev4855/sigouts/0/on', 1)
        time.sleep(0.2)
        self.attr_Amplitude_read = self.daq.getDouble('/dev4855/sigouts/0/amplitudes/0')
    ...
    def write_frequency(self, attr):
        ...
        data = attr.get_write_value()
        #----- PROTECTED REGION ID(ZI.frequency_write) ENABLED START -----#
    ...
    def write_samplingrate(self, attr):
        ...
        data = attr.get_write_value()
        #----- PROTECTED REGION ID(ZI.samplingrate_write) ENABLED START -----#
        self.daq.setDouble('/dev4855/demods/0/rate', data)
        self.daq.setDouble('/dev4855/demods/1/rate', data)
        self.daq.setDouble('/dev4855/demods/2/rate', data)
    ...
    def write_integrationtime(self, attr):
        ...
        data = attr.get_write_value()
        #----- PROTECTED REGION ID(ZI.integrationtime_write) ENABLED START -----#
        ...
        try:
            tc = self.daq.getDouble('/dev4855/demods/0/timeconstant')
    ...
    def read_settlingtime(self, attr):
        ...
        #----- PROTECTED REGION ID(ZI.settlingtime_read) ENABLED START -----#
        settle_99 = {1: 4.6, 2: 6.6, 3: 8.4, 4: 10.0,
                     5: 11.6, 6: 13.1, 7: 14.6, 8: 16.0}
        tc = self.daq.getDouble('/dev4855/demods/0/timeconstant')
        order = int(self.daq.getDouble('/dev4855/demods/0/order'))
    ...
    def Start(self):
        ...
        #----- PROTECTED REGION ID(ZI.Start) ENABLED START -----#
